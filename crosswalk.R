...
BENCH_PATH <- file.path(DATA_ROOT, "external", "pandora-out")    # the benchmark file itself
OUT_XWALK  <- file.path(META_DIR, "county_gid2_crosswalk.csv")
OUT_BENCH  <- file.path(META_DIR, "benchmark_counties_gid2.csv")
